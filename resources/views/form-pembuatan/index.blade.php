                                ...
                                <td class="p-4 border-b border-gray-gray-50">
                                    <div class="flex justify-center space-x-2">
                                        ...
                                        @if ($data->cek == 0)
                                            ...
                                            <button type="button"
                                                 onclick="confirmUpdateStatus('{{ route('form-pembuatan.updateStatus', $data->id) }}')"
                                            ...
                                            <!-- Tombol Hapus (Delete) -->
                                            <button type="button"
                                                onclick="confirmDelete('{{ route('form-pembuatan.destroy', $data->id) }}')"
                                        ...
                                        <!-- Tombol Print -->
                                        @if ($data->cek == 1)
                                            <form action="{{ route('form-pembuatan.print', $data->id) }}" method="GET"
                                                target="_blank">
                                                <button
                                                    class="bg-gray-500 text-white p-1 w-8 h-8 rounded-md hover:bg-gray-600 transition duration-300"
                                                    title="Print">
