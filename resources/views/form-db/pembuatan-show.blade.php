...
<body class="bg-gray-100">
    ...
    <div class="flex justify-center mt-12">
        <div class="w-full max-w-3xl bg-white p-8 rounded-lg shadow-lg border border-gray-300">
            <h1 class="text-2xl font-semibold text-gray-800 mb-8">Form Pembuatan user</h1>
            ...
            <table class="min-w-full table-auto border-collapse border border-gray-200">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border border-graygit -300 px-4 py-2 text-gray-600">{{ $data->tanggal }}</td>
                    </tr>
                    <tr>
