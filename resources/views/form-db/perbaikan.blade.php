            ...
            <div style="flex: 1; margin-right: 20px;">
                <div style="display: flex; flex-wrap: wrap; gap: 20px;">
                    ...
                    <div style="flex: 1; min-width: 45%; margin-bottom: 20px;">
                        ...
                        <input type="text" id="nama_barang" name="nama_barang" style="width: 100%; max-width: 290px; padding: 10px; margin-top: 8px; border-radius: 4px; border: 1px solid #ccc; font-size: 14px;">
                    </div>     
                    ...
                    <div style="flex: 1; min-width: 45%; margin-bottom: 20px;">
                        ...
                        <input type="text" id="spesifikasi" name="spesifikasi" style="width: 100%; max-width: 290px; padding: 10px; margin-top: 8px; border-radius: 4px; border: 1px solid #ccc; font-size: 14px;">
                    </div>     

                    <div style="flex: 1; min-width: 45%; margin-bottom: 20px;">
                        <label for="keluhan" style="display: block; font-weight: bold; font-size: 16px;">Keluhan</label>
                        <input type="text" id="keluhan" name="keluhan" style="width: 100%; max-width: 290px; padding: 10px; margin-top: 8px; border-radius: 4px; border: 1px solid #ccc; font-size: 14px;">
                    </div>     
                </div>

                <button type="submit" onclick="window.print()" style="max-width: 20%; padding: 10px 20px; background-color: #6A1E55; color: white; border: none; border-radius: 4px; cursor: pointer; width: 100%; margin-top: 20px; font-size: 16px;">
                    Save
                </button>
            </div>
