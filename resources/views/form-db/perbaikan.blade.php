...
<div style="display: flex; justify-content: center; padding: 20px;">
    <div style="width: 100%; max-width: 1200px; background: #fff; border-radius: 10px; box-shadow: 0 10px 20px rgba(0, 0, 0, 0.1); padding: 30px;">
        ...
        <div style="display: flex; gap: 20px;">
            <!-- Form Section -->
            <form action="{{ route('perbaikan.store') }}" method="POST" style="flex: 3;">
                @csrf
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
                    ...
                    <div>
                        <label for="tgl_beli" style="display: block; font-weight: 500; margin-bottom: 5px; color: #555;">Tanggal Beli</label>
                        <input type="date" id="tgl_beli" name="tgl_beli" required 
                        value="<?= date('Y-m-d'); ?>" 
                        style="width: 100%; padding: 10px 15px; border-radius: 5px; border: 1px solid #ccc; font-size: 14px;">
                    ...
                    <div>
                        <label for="nama_barang" style="display: block; font-weight: 500; margin-bottom: 5px; color: #555;">Nama Barang</label>
                        <input type="text" id="nama_barang" name="nama_barang" placeholder="Masukkan Nama Barang" required 
                            style="width: 100%; padding: 10px 15px; border-radius: 5px; border: 1px solid #ccc; font-size: 14px;">
                    </div>

                    <div>
                        <label for="jumlah" style="display: block; font-weight: 500; margin-bottom: 5px; color: #555;">Jumlah</label>
                        <input type="text" id="jumlah" name="jumlah" placeholder="Masukkan Jumlah" required 
                            style="width: 100%; padding: 10px 15px; border-radius: 5px; border: 1px solid #ccc; font-size: 14px;">
                    </div>

                    <div>
                        <label for="spesifikasi" style="display: block; font-weight: 500; margin-bottom: 5px; color: #555;">Spesifikasi</label>
                        <input type="text" id="spesifikasi" name="spesifikasi" placeholder="Spesifikasi" required 
                            style="width: 100%; padding: 10px 15px; border-radius: 5px; border: 1px solid #ccc; font-size: 14px;">
                    </div>

                    <div>
                        <label for="keluhan" style="display: block; font-weight: 500; margin-bottom: 5px; color: #555;">Keluhan</label>
                        <input type="text" id="keluhan" name="keluhan" placeholder="Deskripsikan keluhan Anda" required 
                            style="width: 100%; padding: 10px 15px; border-radius: 5px; border: 1px solid #ccc; font-size: 14px;">
                    </div>
                </div>
            ...
            <div style="flex: 1.3; background: #f9f9f9; padding: 20px; border-radius: 10px; border: 1px solid #ddd; box-shadow: 0 5px 15px rgba(0, 0, 0, 0.05); max-width: 450px;">
                ...
                <ul style="list-style: decimal; padding-left: 20px; color: #555; line-height: 1.6;">
                    <li>
                        Minta form disposisi dengan Purchasing. Isi, tanda tangan <b>Pemohon dan Atasan</b>
                    ...
                    <li style="margin-top: 5px">
                     ...
                     <li style="margin-top: 5px">
                        Tanda tangan <b>Pemohon</b>
                        <i class="fa-solid fa-angle-down dropdown-toggle" onclick="toggleDropdown(3)"></i>
                        <div class="dropdown-content">
                    ...
                    <li style="margin-top: 5px">Serahkan <b>Form Disposisi dan Tanda Terima ke IT</b></li>
                </ul>
            </div>
