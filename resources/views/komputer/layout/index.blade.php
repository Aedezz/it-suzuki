...
<div class="flex justify-center items-center mt-10">
    <div class="form-it-container w-full sm:w-11/12 lg:w-10/12 xl:w-11/12 2xl:w-3/4 bg-white rounded-lg shadow-md p-6 relative max-h-[80vh] overflow-hidden">
        ...
        <div class="mt-16 flex justify-start items-center">
            <a href="{{ route('komputer') }}" class="data-link text-sm sm:text-base text-blue-500 relative group mx-2">List</a>
            <a href="{{ route('komputer.create') }}" class="laporan-link text-sm sm:text-base text-blue-500 relative group mx-2">Create</a>
        </div>
