        ...
        <div class="container w-full md:w-4/5 xl:w-3/5 mx-auto px-2">
            ...
            <div id='recipients' class="p-3 mt-6 lg:mt-0 rounded shadow bg-white"
                ...
                <div class="flex justify-between items-center px-4 py-8">
                    ...
                    <!-- Menu -->
                    <a id="create-button" href="{{ route('services.history.create') }}">
                ...
                <table id="example" class="stripe hover" style="width:100%; padding-top: 1em; padding-bottom: 1em;">
                    <thead>
                        <tr>
                            ...
                            <th data-priority="1" class="text-center">Nomor</th>
                            <th data-priority="2" class="text-center">Tanggal</th>
                            <th data-priority="3" class="text-center">NIK</th>
                            <th data-priority="1" class="text-center">Pengguna</th>
                            <th data-priority="4" class="text-center">Perangkat</th>
                            <th data-priority="1" class="text-center">Item</th>
                            <th data-priority="1" class="text-center">Tipe</th>
                            <th data-priority="1" class="text-center">Keterangan</th>
