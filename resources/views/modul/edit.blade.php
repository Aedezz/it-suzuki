            ...
            <div
                ...
                <div class="container mt-2">
                    <div class="form-row flex flex-wrap -mx-2">
                        ...
                        <form action="{{ route('modul.update', $modul->id_modul) }}" method="POST" class="w-full">
                            @csrf
                            @method('PUT')
                            <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <div class="flex flex-col">
                                        <label for="kategori" class="text-sm text-gray-700 font-medium mb-2">Kategori</label>
                                        <input type="text" name="kategori" id="kategori"
                                            value="{{ $modul->nama_kategori }}" readonly
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
                                    </div>
                            </div>
