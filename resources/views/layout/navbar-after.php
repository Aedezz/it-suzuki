...
<head>
    ...
    <style>
        ...
        .navbar {
            min-height: 80px; /* Atur tinggi navbar di desktop */
        }
        ...
        .navbar img {
            height: 3.5rem; /* Set logo height for desktop */
        }
        ...
        .navbar .container a:hover::after {
            ...
            width: 100%;
            height: 2px;
            background-color: #008a0e; /* Warna garis bawah */
...
<nav class="bg-white shadow shadow-gray-300 w-full px-8">
    <div class="container mx-auto flex items-center justify-between flex-wrap" style="margin-top: -8px;">
        ...
        <div class="block md:hidden">
            <button id="menu-toggle" class="focus:outline-none">
                <svg id="menu-icon" class="h-8 w-9 pt" style="margin-top: 20px;" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
   ...
   <!-- Desktop Navigation (hidden on mobile) -->
<div class="hidden md:flex md:items-center md:w-auto md:max-h-full" style="margin-bottom: -10px; margin-right: 90px;">
    <ul class="text-gray-500 font-semibold md:space-x-2 md:flex md:flex-row" style="font-size: 16px;">
        ...
        <li class="relative">
            ...
            <!-- Dropdown Items -->
            <ul class="absolute left-0 hidden bg-white text-gray-500 font-semibold space-y-2 w-48 shadow-md mt-2 rounded-lg z-10">
                <li><a href="#" class="block px-4 py-2 hover:text-indigo-400">Install Komputer & Laptop</a></li>
                <li><a href="#" class="block px-4 py-2 hover:text-indigo-400">Pembuatan User & Reset Password</a></li>
        ...
        <div id="menu" class="slide-up w-full md:hidden">
            ...
            <div class="mt-4">
                <button class="w-full px-4 py-2 bg-red-500 hover:bg-indigo-600 text-white rounded-xl flex items-center justify-center gap-2" style="margin-bottom: 20px">
